...
CREATE TABLE `sanitation_ep_summary` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新日期',
  `sys_org_code` varchar(64) DEFAULT NULL COMMENT '所属部门',
  `vehicle` int(32) DEFAULT NULL COMMENT '环卫作业车辆',
  `person_time` int(32) DEFAULT NULL COMMENT '环卫作业人员',
  `garbage_disposal` double(32,0) DEFAULT NULL COMMENT '生活垃圾无害化处理',
  `kz_kouzh_feiqt` int(32) DEFAULT NULL COMMENT '口罩废弃桶',
  `kz_yunsl` int(32) DEFAULT NULL COMMENT '运输量',
  `xs_gongc` int(32) DEFAULT NULL COMMENT '消杀-公厕',
  `xs_lajz` int(32) DEFAULT NULL COMMENT '消杀-垃圾站',
  `xs_huanwcc` int(32) DEFAULT NULL COMMENT '消杀-环卫作业车辆',
  `xs_guokx` int(32) DEFAULT NULL COMMENT '消杀-果壳箱与垃圾桶',
  `hjws_lajcl` double(32,0) DEFAULT NULL COMMENT '生活垃圾无害化处理',
  `hjws_xiaoscc` int(32) DEFAULT NULL COMMENT '单位内部疫情防控消杀处理情况',
  `hjws_hubei_jiecqk` varchar(512) DEFAULT NULL COMMENT '本单位职工涉湖北接触情况',
  `fywz_kouzh` int(32) DEFAULT NULL COMMENT '口罩',
  `fywz_jiuj` double(32,0) DEFAULT NULL COMMENT '酒精',
  `fywz_wendj` int(32) DEFAULT NULL COMMENT '温度计',
