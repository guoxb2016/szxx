...
CREATE TABLE `citymanager_ep_summary` (
  ...
  `person_time` int DEFAULT NULL COMMENT '出动执法人员次数',
  `strvend_poultry` int DEFAULT NULL COMMENT '活禽宰杀流动摊贩管理',
  `strvend_wildlife` int DEFAULT NULL COMMENT '贩卖野生动物流动摊贩管理',
  `strvend_other` int DEFAULT NULL COMMENT '其它流动摊贩',
...
-- ----------------------------
INSERT INTO `onl_cgform_head` VALUES ('147330c643c447908c2e6f6ea19cf878', 'sanitation_summary', '1', '9', '环卫信息汇总表', 'Y', 'Y', 'Y', 'N', null, 'UUID', 'single', null, null, null, null, null, null, 'bdfl_include', '1', null, '0', null, '0', null, 'admin', '2020-02-21 16:04:29', 'admin', '2020-02-21 14:09:39');
...
CREATE TABLE `sanitation_ep_summary` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新日期',
  `sys_org_code` varchar(64) DEFAULT NULL COMMENT '所属部门',
  `vehicle` int DEFAULT NULL COMMENT '环卫作业车辆',
  `person_time` int DEFAULT NULL COMMENT '环卫作业人员',
  `garbage_disposal` double(32,0) DEFAULT NULL COMMENT '生活垃圾无害化处理',
  `kz_kouzh_feiqt` int DEFAULT NULL COMMENT '口罩废弃桶',
  `kz_yunsl` int DEFAULT NULL COMMENT '运输量',
  `xs_gongc` int DEFAULT NULL COMMENT '消杀-公厕',
  `xs_lajz` int DEFAULT NULL COMMENT '消杀-垃圾站',
  `xs_huanwcc` int DEFAULT NULL COMMENT '消杀-环卫作业车辆',
  `xs_guokx` int DEFAULT NULL COMMENT '消杀-果壳箱与垃圾桶',
  `hjws_lajcl` double(32,0) DEFAULT NULL COMMENT '生活垃圾无害化处理',
  `hjws_xiaoscc` int DEFAULT NULL COMMENT '单位内部疫情防控消杀处理情况',
  `hjws_hubei_jiecqk` varchar(512) DEFAULT NULL COMMENT '本单位职工涉湖北接触情况',
  `fywz_kouzh` int DEFAULT NULL COMMENT '口罩',
  `fywz_jiuj` double(32,0) DEFAULT NULL COMMENT '酒精',
  `fywz_wendj` int DEFAULT NULL COMMENT '温度计',
...
CREATE TABLE `sanitation_summary` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新日期',
  `sys_org_code` varchar(64) DEFAULT NULL COMMENT '所属部门',
  `gr_baojy` int DEFAULT NULL COMMENT '保洁员（操作工）',
  `gr_siji_sais` int DEFAULT NULL COMMENT '扫洒司机',
  `gr_siji_lajysh` int DEFAULT NULL COMMENT '垃圾运输司机',
  `gr_nan` int DEFAULT NULL COMMENT '男',
  `gr_nv` int DEFAULT NULL COMMENT '女',
  `gr_lessand45` int DEFAULT NULL COMMENT '45岁及以下',
  `gr_more45` int DEFAULT NULL COMMENT '45岁以上',
  `gr_lingshg` int DEFAULT NULL COMMENT '临时工',
  `gr_zhengshg` int DEFAULT NULL COMMENT '正式工',
  `gr_huanwgl` int DEFAULT NULL COMMENT '环卫管理人员',
  `chl_gans` int DEFAULT NULL COMMENT '干扫车',
  `chl_xis` int DEFAULT NULL COMMENT '洗扫车',
  `chl_xich` int DEFAULT NULL COMMENT '真空吸尘车',
  `chl_saod_xiao` int DEFAULT NULL COMMENT '扫道小型车',
  `chl_saod_da` int DEFAULT NULL COMMENT '扫道大型车',
  `chl_sash_xiao` int DEFAULT NULL COMMENT '洒水小型车',
  `chl_sash_da` int DEFAULT NULL COMMENT '洒水大型车',
  `chl_wuc` int DEFAULT NULL COMMENT '雾炮车',
  `chl_lajysh` int DEFAULT NULL COMMENT '垃圾运输车',
  `chl_diandbj` int DEFAULT NULL COMMENT '电动保洁车',
  `shsh_lajzh` int DEFAULT NULL COMMENT '普通垃圾站',
  `shsh_fenleilajzh` int DEFAULT NULL COMMENT '分类垃圾站',
  `shsh_huanwgc_yil` int DEFAULT NULL COMMENT '一类环卫公厕',
  `shsh_huanwgc_erl` int DEFAULT NULL COMMENT '二类环卫公厕',
  `shsh_shehgc` int DEFAULT NULL COMMENT '社会公厕',
  `shsh_guokx` int DEFAULT NULL COMMENT '分类果壳箱',
  `shsh_lajt` int DEFAULT NULL COMMENT '分类垃圾桶',
  `bj_yl_shul` int DEFAULT NULL COMMENT '一类道路数量',
  `bj_yl_changd` int DEFAULT NULL COMMENT '一类道路长度',
  `bj_yl_mianj` double DEFAULT NULL COMMENT '一类道路面积',
  `bj_yl_jinfbzh` double DEFAULT NULL COMMENT '一类道路经费标准',
  `bj_erl_shul` int DEFAULT NULL COMMENT '二类道路数量',
  `bj_erl_changd` int DEFAULT NULL COMMENT '二类道路长度',
  `bj_erl_mianj` double DEFAULT NULL COMMENT '二类道路面积',
  `bj_erl_jinfbzh` double DEFAULT NULL COMMENT '二类道路经费标准',
  `bj_ssl_shul` int DEFAULT NULL COMMENT '三四类道路数量',
  `bj_ssl_changd` int DEFAULT NULL COMMENT '三四类道路长度',
  `bj_ssl_mianj` double DEFAULT NULL COMMENT '三四类道路面积',
  `bj_ssl_jinfbzh` double DEFAULT NULL COMMENT '三四类道路经费标准',
  `bj_shq_shul` int DEFAULT NULL COMMENT '社区数量',
  ...
  `bj_jixh_qings_cang` int DEFAULT NULL COMMENT '机械化清扫长度',
  ...
  `ful_tijian` int DEFAULT NULL COMMENT '单位组织体检人数',
  `ful_jiejia` varchar(512) DEFAULT NULL COMMENT '节日福利标准（包括春节、端午节、中秋节及环卫工人节）	',
  `ful_yiwai_baoxian` int DEFAULT NULL COMMENT '购意外伤害险人数	',
  `ful_shehui_baoxian` int DEFAULT NULL COMMENT '社会保险缴纳人数',
  ...
  `ful_gongjijing` int DEFAULT NULL COMMENT '缴纳公积金人数',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `sys_permission` VALUES ('1230767770552692738', null, '汇总', '/summary', '	layouts/RouteView', null, null, '0', null, '1', '1.00', '0', null, '1', '0', '0', '0', null, 'admin', '2020-02-21 16:14:38', null, null, '0', '0', '1', '0');
INSERT INTO `sys_permission` VALUES ('1230768636911349762', '1230767770552692738', '公厕统计明细', '/summary/toilet', 'layouts/RouteView', null, null, '1', null, '1', '1.00', '0', null, '1', '1', '0', '0', null, 'admin', '2020-02-21 16:18:04', null, null, '0', '0', '1', '0');
...
CREATE TABLE `toilet_summary` (
  ...
  `nan` int DEFAULT NULL COMMENT '男蹲位数量',
  `nv` int DEFAULT NULL COMMENT '女蹲位数量',
  `tongyong` int DEFAULT NULL COMMENT '通用蹲位数量',
  `wuzhangai` int DEFAULT NULL COMMENT '无障碍蹲位数量',
  `xiaobiandou` int DEFAULT NULL COMMENT '小便斗数量',
